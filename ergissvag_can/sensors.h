...
// Diagnoza I2C — scan complet bus + dump primii regs de la 0x2C (chip neidentificat).
// Apelata periodic din loop() ca sa fie vizibil in Serial Monitor chiar si dupa boot.
